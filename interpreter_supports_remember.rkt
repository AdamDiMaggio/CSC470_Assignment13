...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname interpreter_supports_remember) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;constructor
(define empty-env
